...
| File                  | Nature of changes                                              |
| --------------------- | -------------------------------------------------------------- |
| Vendored snapshot     | No local source delta; synced to upstream `@agentclientprotocol/claude-agent-acp` `0.34.0` (`925865216927eb45a5c5877b21dd7373f5b0193a`) with vendored `dist/` runtime files |
